package com.uprise.ordering.service;
...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (location == null) {
            ...
            deliverResultToReceiver(ApplicationConstants.FAILURE_RESULT, location);
            return;
        }
        ...
        try {
            ...
            Log.e(TAG, errorMessage + ". " +
                    "Latitude = " + location.getLocation().latitude +
                    ", Longitude = " + location.getLocation().longitude, illegalArgumentException);
        }
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            location.setAddress(errorMessage);
            deliverResultToReceiver(ApplicationConstants.FAILURE_RESULT, location);
        } else {
...
//            if(null != address.getPostalCode()) addressFragments.add(address.getPostalCode());
//            addressFragments.add(address.getCountryCode());
            Log.i(TAG, getString(R.string.address_found));
            location.setAddress(TextUtils.join(", ", addressFragments));
